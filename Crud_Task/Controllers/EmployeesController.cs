...
namespace Crud_Task.Controllers
{
    ...
    {
        private readonly Crud_TaskContext _context;

        public EmployeesController(Crud_TaskContext context)
        {
            _context = context;
        }
        ...
        {
            var crud_TaskContext = _context.Employees.Include(e => e.Department);
            return View(await crud_TaskContext.ToListAsync());
        }
